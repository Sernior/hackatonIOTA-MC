...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../../dependencies/std/macros.md#std_macros_uq_from_quotient">uq_from_quotient</a>&lt;$T, $U&gt;(
    ...
    // Scale the numerator to have `$t_bits` <a href="../../nplex/fractional.md#(nplex=0x0)_fractional">fractional</a> bits and the denominator to have
    // `$t_bits - $fractional_bits` <a href="../../nplex/fractional.md#(nplex=0x0)_fractional">fractional</a> bits, so that the quotient will have
    // `$fractional_bits` <a href="../../nplex/fractional.md#(nplex=0x0)_fractional">fractional</a> bits.
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../../dependencies/std/macros.md#std_macros_uq_int_mul">uq_int_mul</a>&lt;$T, $U&gt;(
    ...
    // The unscaled product <b>has</b> `$fractional_bits` <a href="../../nplex/fractional.md#(nplex=0x0)_fractional">fractional</a> bits (from the multiplier)
...
<pre><code><b>public</b> <b>macro</b> <b>fun</b> <a href="../../dependencies/std/macros.md#std_macros_uq_int_div">uq_int_div</a>&lt;$T, $U&gt;(
    ...
    // and then shift left to add `$fractional_bits` <a href="../../nplex/fractional.md#(nplex=0x0)_fractional">fractional</a> zero bits to the dividend.
